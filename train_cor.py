...
from module import EightCornerModule
...
if __name__ == '__main__':
    parser = ArgumentParser('Train pixel corner model')
    ...
    callbacks += [pl.callbacks.ModelCheckpoint(
        verbose=True,
        save_top_k=5,
        filename='{epoch}-{valid_chamfer_distance}',
        monitor='valid_chamfer_distance',
        mode='min'
    )]
